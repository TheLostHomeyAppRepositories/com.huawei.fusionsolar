...
module.exports = {
  ...
  // Bounds for the configurable interval. Below 10 s the loop would poll the car APIs
  // harder than they like without changing behaviour — nearly every decision is gated by
  // hold timers of 30 s and up. Above 60 s the battery floor and the import ceiling react
  // too late to be worth calling a safety limit.
  TICK_MIN_S:               10,
  TICK_MAX_S:               60,
  STEP_HOLD_MS:             30_000,
