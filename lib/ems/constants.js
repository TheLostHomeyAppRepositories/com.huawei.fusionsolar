...
module.exports = {
  ...
  // Without a back-off FLIP_COOLDOWN_MS alone would have it poked every six minutes for as
  // long as the sun shines — eleven times in the log that prompted this. The deliberate
  // tiers (instant, always-charge, off-peak) are NOT blocked: those are the user asking.
  CHARGER_IGNORED_BACKOFF_MS: 30 * 60_000,
