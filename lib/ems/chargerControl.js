    ...
    for (const c of chargers) {
      ...
      if (car && car.soc !== null && car.target !== null) {
        ...
        if (!st.socBlindLogged) {
          ...
          // Two different situations reach this branch and only one of them is a blind
          // spot. A car with no target source at all is not unreadable — it is a car
          // nobody asked to stop early, and saying "not checkable" about it sends people
