...
module.exports = {
  ...
  async _evaluateSimpleDevices(battery, gridW, devices, stateMap, startCard, stopCard, tokenName, cfgControlKey, cfg) {
    ...
    // Waermepumpe/Boiler/Pool/Entfeuchter behalten vorerst den klassenweiten Schalter:
    // ihre Zeilen auf der Einstellungsseite haben noch keinen Schalter je Geraet, ein
    // Entfernen wuerde die Klasse unabschaltbar machen. Nur die Lader sind umgestellt.
